...
import com.cuncis.googlemaps2020.models.PolylineData;
...
import com.cuncis.googlemaps2020.util.ViewWeightAnimationWrapper;
...
public class UserListFragment extends Fragment implements
    ...
    private void calculateDirections(Marker marker){
        ...
        directions.alternatives(true);  // all route (not best one)
        directions.origin(
...
//        setCameraView();
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.btn_reset_map) {
            addMapMarkers();
        }
    }
    ...
    public void onUserClick(int position) {
        Log.d(TAG, "onUserClick: selected a user: " + mUserList.get(position).getUser_id());
